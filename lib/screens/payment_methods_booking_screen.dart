...
class PaymentMethodsBookingScreen extends StatefulWidget {
  const PaymentMethodsBookingScreen({super.key});

  @override
  _PaymentMethodsBookingScreenState createState() => _PaymentMethodsBookingScreenState();
}

class _PaymentMethodsBookingScreenState extends State<PaymentMethodsBookingScreen> {
  ...
  Widget _buildPaymentMethodsList() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        String cardNumber = payment['last4'] ?? 'xxxx';
        String expiration = payment['validity'] ?? 'MM/YY';
        String cardType = (payment['type'] is Map)
            ? payment['type']['name'] ?? 'Unknown'
